...
export const demoMaterials: Material[] = [
  ...
  { id: id("mat", 4), userId: "demo-user", name: "Chilli", unit: "kg", currentQty: 30, requiredQty: 20, minLevel: 10 },
  { id: id("mat", 5), userId: "demo-user", name: "Oil", unit: "litre", currentQty: 20, requiredQty: 15, minLevel: 10 },
  { id: id("mat", 6), userId: "demo-user", name: "Salt", unit: "kg", currentQty: 25, requiredQty: 12, minLevel: 8 },
  { id: id("mat", 7), userId: "demo-user", name: "Spices", unit: "kg", currentQty: 3, requiredQty: 5, minLevel: 4 },
  { id: id("mat", 8), userId: "demo-user", name: "Jars", unit: "packet", currentQty: 180, requiredQty: 150, minLevel: 60 },
  {
    id: id("mat", 9),
    userId: "demo-user",
